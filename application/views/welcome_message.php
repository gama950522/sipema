<div class="col-md-12" style="margin-top: 20px ">
    ...
    <!-- <iframe src="C:\Users\Alexis\Videos\Jack.reacher.never.go.back.2016.1080p-dual-lat.mp4"></iframe> -->
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img class="third-slide img-responsive" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Third slide">
                    <!-- <div class="container">
                        <div class="carousel-caption">
